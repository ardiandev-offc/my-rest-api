    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api ArdianOfc - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=62895328298685">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>ArdianOfc</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"ArdianDev" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api ArdianDev`,
        html: inboxGmail,
      };
